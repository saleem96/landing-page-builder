...
<div class="row">
    ...
    <div class="col-md-10">
        ...
        <form role="form" method="post" action="{{ route('settings.blockscategories.update', $category->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="card">
                ...
                <div class="card-footer">
                    <div class="d-flex">
                        <a href="{{ route('settings.blockscategories.index') }}" class="btn btn-secondary">@lang('Cancel')</a>
